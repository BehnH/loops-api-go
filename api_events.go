...
// Include a unique ID for this request (maximum 100 characters) to avoid duplicate events. [More info](https://loops.so/docs/api-reference/send-event#param-idempotency-key)
func (r ApiEventsSendPostRequest) IdempotencyKey(idempotencyKey string) ApiEventsSendPostRequest {
