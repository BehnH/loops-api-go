...
// GetMailingListsOk returns a tuple with the MailingLists field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ContactRequest) GetMailingListsOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.MailingLists) {
		return map[string]interface{}{}, false
	}
	return o.MailingLists, true
}
...
func (o ContactRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MailingLists) {
		toSerialize["mailingLists"] = o.MailingLists
	}
